...
"""
            return HttpResponse("Redfish/v1/, yes")
        else:
...
def redfishv1(request):
    ...
    if (request.path=='/redfish/v1/'):
        ...
        Loadfromfile = True
        if (Loadfromfile):
            with open('/home/accton/Pyroot/uione/accton/pod_manager/atnurllib/rmm.txt') as f:
...
# https://127.0.0.1:8091
# This file was good before
def redfishv0209(request):
    # remember this format
    if (request.path=='/redfish/v1/'):
        test1 =  ':8091/refdish/v1'
        Loadfromfile = True
