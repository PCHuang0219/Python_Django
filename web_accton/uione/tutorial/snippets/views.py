...
from snippets import UserSerializer
...
class SnippetList(generics.ListCreateAPIView):
    ...
    The way we deal with that is by overriding a .perform_create() method 
    on our snippet views, that allows us to modify how the instance save is 
    managed, and handle any information that is implicit in the incoming 
...
# Tutorial 3, phrase 2, very good, but it's not excellent
#
#
#
# from snippets.models import Snippet
...
# Tutorial 3, phrase 1, good but not good enough
#
#
# from snippets.models import Snippet
# from snippets.serializers import SnippetSerializer
