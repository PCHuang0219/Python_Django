...
let getJobStatus = function(){
    ...
    if(getUrlParameter("jobId")){
        $.ajax({
            type: "get",
            url: window.location.origin + "/test/detail/testTableInJob/",
            data:{job_id: job_id},
            dataType: "json",
            ...
            $("button").click(function(){
                ...
                test_id = test_id - 1;
                location.href = window.location.origin + "/test/jobManagement/jobDetail/jobLog/?testId=" + test_id + "&jobId=" + job_id
            });
            },
        })
    }
