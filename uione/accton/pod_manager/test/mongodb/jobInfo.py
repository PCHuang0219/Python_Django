    ...
    def get_testcase_list(self):
        ...
        for testcase_name in self.testcase_list:
            if self.platform == "Facebook":
                testcase = {'test_id':index,\
                            'test_case':"",\
                            'test_name':testcase_name,\
                            'test_topo':"Minipack",\
                            'test_status':"not running",\
                            'test_start_time':"NULL",\
                            'test_end_time':"not finished",\
                            'test_log_path':"not finished",\
                            'test_result':"not finished"}
                testcase_list_json.append(testcase)
            else:
                testcase = Testcase(testcase_name,index)
